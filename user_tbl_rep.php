  ...
  <section class="home-section">
      <div class="container_form">
          ...
          <div class="input-group rounded ">
            ...
            <a class="btn btn-primary ms-auto" role="button" href="user_inventory_add.php">
                       Add Data
              </a>
          ...
          <table class="_table">
              ...
              <?php 
                  ...
                  $query = "SELECT * FROM tree_inventory WHERE user_id='$id'";
                  $query_run = mysqli_query($conn, $query);
                    ...
                    if(mysqli_num_rows($query_run) > 0)
                    {
                      ...
                      <tr>
                            ...
                            <td><?php echo $row['no_alive'];?></td>
                            <td><?php echo $row['no_dead'];?></td>
                            <td><?php echo $row['remarks'];?></td>
                            <td>
                            
                            <div class="action_container">
                                <a href="user_inventory_edit.php?num=<?= $row['id']; ?>" class="btn btn-primary" role="button" style="margin-right:3px">
